...
export default function AICoach() {
  ...
  return (
    <section id="ai-koc" className="relative py-16 lg:py-20 px-6 bg-[#0a0e1a] overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.2) 0%, rgba(20, 184, 166, 0.1) 50%, rgba(6, 182, 212, 0.15) 100%)',
                filter: 'blur(40px)'
              }}
            />

            {/* Chat Container - Premium Glass */}
            <div className="relative bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl rounded-2xl p-4 shadow-2xl border border-white/10">
                  ...
                  <motion.div
                    ...
                    animate={{
                      background: [
                        ...
                        'linear-gradient(135deg, #06b6d4 0%, #10b981 50%, #14b8a6 100%)',
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent uppercase tracking-wider">AI Coach</span>
            </motion.div>
            ...
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-extrabold text-white mb-4 leading-[1.1]">
              ...
              <span className="relative">
                ...
                <motion.div
                  className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-full"
                  initial={{ scaleX: 0 }}
            ...
            <p className="text-base lg:text-lg text-white/60 mb-6 leading-relaxed max-w-lg">
              Sadece ne yapman gerektiğini söylemez, <span className="text-white/90 font-medium">nasıl yapman gerektiğini gösterir.</span> Hatalarını anında fark eder ve sesli/görsel geri bildirim verir.
            </p>
