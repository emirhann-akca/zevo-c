...
import { Users, Trophy, Zap, Activity, ChevronRight, Dumbbell } from 'lucide-react'
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 bg-[#0f172a] p-6 flex flex-col pt-14">
                                        ...
                                        <div className="relative z-10 h-full">
                                            ...
                                            {/* FEATURE 2: PERSONAL PROGRAM (Formerly SOCIAL) */}
                                            <div className={`absolute inset-0 flex flex-col pt-8 px-1 transition-all duration-500 ${activeFeature === 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>

                                                {/* Header */}
                                                <div className="mb-6 px-4">
                                                    <h3 className="text-white text-2xl font-bold leading-tight">{t.whyZevo.phone.phoneTitle}</h3>
                                                    <p className="text-purple-400 text-sm mt-1">{t.whyZevo.phone.phoneSubtitle}</p>
                                                </div>

                                                {/* Exercise List */}
                                                <div className="space-y-3 flex-1 overflow-y-auto px-2 no-scrollbar">
                                                    {/* Exercise 1 */}
                                                    <div className="flex items-center justify-between gap-3 bg-white/5 border border-white/10 rounded-xl p-3 hover:bg-white/10 transition-colors group">
                                                        <div className="flex-1 min-w-0">
                                                            <p className="text-white text-sm font-semibold truncate">Bench Press</p>
                                                            <p className="text-gray-400 text-[10px] mt-0.5">4 × 8-10 {t.whyZevo.phone.reps}</p>
                                                        </div>
                                                        <div className="text-emerald-400 text-xs font-bold bg-emerald-500/10 px-2 py-1 rounded-md border border-emerald-500/20 shrink-0">
                                                            75kg
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center justify-between gap-3 bg-white/5 border border-white/10 rounded-xl p-3 hover:bg-white/10 transition-colors group">
                                                        <div className="flex-1 min-w-0">
                                                            <p className="text-white text-sm font-semibold truncate">Incline Dumbbell Press</p>
                                                            <p className="text-gray-400 text-[10px] mt-0.5">3 × 10-12 {t.whyZevo.phone.reps}</p>
                                                        </div>
                                                        <div className="text-purple-400 text-xs font-bold bg-purple-500/10 px-2 py-1 rounded-md border border-purple-500/20 shrink-0">
                                                            24kg
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center justify-between gap-3 bg-white/5 border border-white/10 rounded-xl p-3 hover:bg-white/10 transition-colors group">
                                                        <div className="flex-1 min-w-0">
                                                            <p className="text-white text-sm font-semibold truncate">Triceps Pushdown</p>
                                                            <p className="text-gray-400 text-[10px] mt-0.5">3 × 12-15 {t.whyZevo.phone.reps}</p>
                                                        </div>
                                                        <div className="text-blue-400 text-xs font-bold bg-blue-500/10 px-2 py-1 rounded-md border border-blue-500/20 shrink-0">
                                                            30kg
                                                        </div>
                                                    </div>
                                                </div>
